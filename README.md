...
| Button | Action |
| ------ | ------ |
| Dpad | Select menu's, levels to play in level selector, Move Player during game play, Switch players if 2 players exists|
...
- move.wav - created by me (willems davy) using BXFR - feel free to use
